...
Lisez et adaptez [chat_parsing.js](https://github.com/VGKhiem/mineflayer-khiem/blob/master/examples/chat_parsing.js) pour qu'il fonctionne pour vos besoins particuliers.
