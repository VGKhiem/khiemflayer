...
function inject (bot) {
   ...
   * @param {import('khiemflayer-minecraft-vec3').Vec3} faceVector
   * @param {{half?: 'top'|'bottom', delta?: import('khiemflayer-minecraft-vec3').Vec3, forceLook?: boolean | 'ignore', offhand?: boolean, swingArm?: 'right' | 'left', showHand?: boolean}} options
   */
