...
const { OctahedronIterator } = require('khiemflayer-minecraft-world').iterators
...
function inject (bot, { version, storageBuilder, hideErrors }) {
  const Block = require('khiemflayer-minecraft-block')(bot.registry)
  const Chunk = require('khiemflayer-minecraft-chunk')(bot.registry)
  const World = require('khiemflayer-minecraft-world')(bot.registry)
