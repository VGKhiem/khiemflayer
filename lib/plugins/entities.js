...
function inject (bot) {
  ...
  const Entity = require('khiemflayer-minecraft-entity')(bot.version)
  const Item = require('khiemflayer-minecraft-item')(bot.version)
  const ChatMessage = require('khiemflayer-minecraft-chat')(bot.registry)
