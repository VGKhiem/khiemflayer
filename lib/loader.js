...
function createBot (options = {}) {
  if (options.viaProxy || options.forceViaProxy) {
    const viaproxy = require('khiemflayer-viaproxy')
    const noProxyOpts = { ...options }
    delete noProxyOpts.viaProxy
    delete noProxyOpts.forceViaProxy
    return viaproxy.createBot(options, createBot)
  }
  ...
  function next () {
    ...
    bot.registry = require('khiemflayer-minecraft-registry')(serverPingVersion)
